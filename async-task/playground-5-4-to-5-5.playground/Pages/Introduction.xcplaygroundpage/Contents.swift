...
This playground is designed to showcase new features introduced after Swift 5.4, up to and including Swift 5.5. If you hit problems or have questions, you're welcome to tweet me [@twostraws](https://twitter.com/twostraws) or email <paul@hackingwithswift.com>.
 ...
 * [Interchangeable use of `CGFloat` and `Double` types](Interchangeable%20use%20of%20CGFloat%20and%20Double%20types)
 ...
 * [Extending property wrappers to function and closure parameters](Extending%20property%20wrappers%20to%20function%20and%20closure%20parameters)
